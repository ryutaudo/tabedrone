...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return {
    addEntryToFridge: function addEntryToFridge(name, amount) {
      return dispatch((0, _index.addEntryToFridge)(name, amount));
    },
    removeEntryFromFridge: function removeEntryFromFridge(name, amount) {
...
var addEntryToFridge = function addEntryToFridge(contentName, amount) {
  return {
...
var initProductList = function initProductList(listOfProducts) {
  return {
    type: 'INIT',
...
var removeEntryFromFridge = function removeEntryFromFridge(contentName, amount) {
  return {
...
var _reactConfirmAlert = __webpack_require__(74);

__webpack_require__(75);

var _Headline = __webpack_require__(78);
...
var App = function (_Component) {
  ...
  _createClass(App, [{
    ...
    key: 'addFridgeEntry',
    value: async function addFridgeEntry(event) {
      ...
      await fetch('/api/order', {
        ...
        body: JSON.stringify({ customerId: this.props.customerId, cart: [{ name: name, amount: amount }] })
      });
    }
  }, {
    key: 'removeFridgeEntry',
    value: async function removeFridgeEntry(event) {
      var name = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : '';
      var amount = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 1;
    ...
    value: function handleSubmit() {
      (0, _reactConfirmAlert.confirmAlert)({
        ...
        onConfirm: function onConfirm() {
          return alert('Action after Confirm');
        }, // Action after Confirm
        onCancel: function onCancel() {
          return alert('Action after Cancel');
        } // Action after Cancel
      });
    }
  }, {
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'div',
          { className: 'fridge' },
          Object.keys(this.props.fridgeContent).map(function (name, idx) {
            return _react2.default.createElement(
              'div',
...
var _Headline = __webpack_require__(79);
...
var VisibleHeadline = (0, _reactRedux.connect)(null, // mapStateToProps,
null // mapDispatchToProps,
)(_Headline2.default);
// import { toggleTodo } from '../actions';
exports.default = VisibleHeadline;
